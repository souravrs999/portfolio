...
>((props: TestimonialCardProps, ref?: Ref<HTMLDivElement>) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "w-full bg-white dark:bg-[#111] gap-12 flex flex-wrap items-center border dark:border-[#1e1e1e] py-8 px-12",
        className
      )}
      {...rest}
    >
      <div className="w-20 h-20 relative overflow-hidden rounded-full outline-4 outline-[#111] dark:outline-[#1e1e1e] outline-dashed outline-offset-8 ring-4 ring-gray-300 dark:ring-[#1e1e1e] shrink-0">
